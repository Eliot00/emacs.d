...
(set-fontset-font t 'unicode (font-spec :family "Maple Mono NF"))
(set-fontset-font t 'han (font-spec :family "LXGW WenKai Mono TC"))
(set-fontset-font t 'kana (font-spec :family "LXGW WenKai Mono TC"))
(set-fontset-font t 'cjk-misc (font-spec :family "LXGW WenKai Mono TC"))
(set-fontset-font t 'bopomofo (font-spec :family "LXGW WenKai Mono TC"))
(set-face-attribute 'variable-pitch nil :family "LXGW WenKai TC")
(set-face-attribute 'fixed-pitch nil :family "LXGW WenKai Mono TC")
#+END_SRC
