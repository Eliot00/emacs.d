...
** 字體
#+BEGIN_SRC emacs-lisp
(set-fontset-font "fontset-startup" 'unicode (font-spec :family "Maple Mono NF CN"))
(set-face-attribute 'default nil :height 180)
(set-face-attribute 'fixed-pitch nil :inherit 'default)
(create-fontset-from-fontset-spec
  (font-xlfd-name
    (font-spec :family "LXGW WenKai Mono TC"
               :registry "fontset-cn")))
(set-fontset-font "fontset-cn" 'unicode (font-spec :family "LXGW WenKai Mono TC"))
(set-face-attribute 'variable-pitch nil :fontset "fontset-cn")
#+END_SRC
